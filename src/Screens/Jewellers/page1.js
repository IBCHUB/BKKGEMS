      ...
      <ScrollView style={{backgroundColor: '#EEECE2'}}>
        <View style={styles.viewdetail}>
          ...
          <Text style={[styles.textdetail, {color: '#fff'}]}>
            ...
            extreme, and bodes well for the future of the Thai jewelry industry.
            Some designers and brands are already well-known internationally and
            more are expected to break into the global scene. Their
            international success is the result of great talent and inner spirit
            plus strong support from suppliers, manufacturers and skilled labour
            force who offer both reliability and quality in what they produce.
            Catch a glimpse of Thai jewelry design at our showcase and be
            inspired.
          </Text>
        </View>
