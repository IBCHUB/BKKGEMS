        ...
        <ScrollView style={{backgroundColor: '#EEECE2'}}>
          <View style={styles.viewdetail}>
            ...
            <Text style={[styles.textdetail, {color: '#fff'}]}>
              ...
              Through fresh and unique designs with the use of the best
              materials, new jewelry brands add a breath of fresh air to jewelry
              scene. {'\n'}
          ...
          <View style={[styles.viewdetail, {backgroundColor: '#EEECE2'}]}>
            ...
            <Text style={[styles.textdetail, {color: '#636363'}]}>
              Showcased innovative products from start-ups as well as jewelry
              that utilizes new techniques.
            </Text>
            <Image
          ...
          <View style={styles.viewdetail}>
            ...
            />
            <Text style={[styles.textdetail, {color: '#fff'}]}>
              Featured the latest trends in jewelry for niche markets.
              Specially, this focused on five main product groups:
            </Text>
            <Image
