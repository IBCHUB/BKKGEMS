      ...
      <ScrollView style={{backgroundColor: '#EEECE2'}}>
        ...
        <View style={[styles.viewdetail, {backgroundColor: '#EEECE2'}]}>
          ...
          <Text style={[styles.textdetail, {color: '#636363'}]}>
            ...
            attract commercial opportunities in line with the Creative Thailand
            policy. The showcase is divided into 3 areas.{'\n'}
            {'\n'}- Innovation and Design Showcase is an exhibition of
            innovative works and designs as well as the promotional area for the
            T MARK symbol where interested exhibitors can register to
            participate in the program. {'\n'}
            {'\n'}- Innovation and Design Bazaar is a space for promoting
            innovative Thai jewelry entrepreneurs and startups to participate in
            business matching activities, and conduct marketing activities to
            ...
            organizations, namely, the Office of the Higher Education Commission
            (OHEC) by the College of Creative Industry, Srinakharinwirot
            University.
          </Text>
        </View>
      </ScrollView>
