      ...
      <ScrollView style={{backgroundColor: '#EEECE2'}}>
        <View style={styles.viewdetail}>
          ...
          <Text style={[styles.textdetail, {color: '#fff'}]}>
            ...
            participated in the Designers’ Room and Talent Thai project held by
            the Department of International Trade Promotion, Ministry of
            ...
            creation of feminine jewelry pieces such as necklaces and earrings;
            and Gleamwood, a brand that utilizes wood combined with materials
            such as rope, silver, and leather to make modern Thai-styled jewelry
            collections.
          </Text>
        </View>
        <View style={[styles.viewdetail, {backgroundColor: '#EEECE2'}]}>
          ...
          <Text style={[styles.textdetail, {color: '#636363'}]}>
            ...
            features innovative and uniquely-designed gems and jewelry products
            at the 63rd Bangkok Gems & Jewelry Fair at the Innovation and Design
            Zone (IDZ). The exhibition showcases creations from jewelry brands
            including those developed by university students, with the aim to
            develop commercial uses, seek business matching partners, and
            showcase highlight products. {'\n'}
            {'\n'}Petchploy Panyasai uses polymer clay — a flexible material
            that hardens with baking – combined with glass blowing techniques to
            make jewelry, while Nympheart selects natural wood with defects to
            combine with resin to make unique necklaces, and Siam Fashion
