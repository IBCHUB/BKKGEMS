      ...
      <ScrollView style={{backgroundColor: '#EEECE2'}}>
        <View style={styles.viewdetail}>
          ...
          <Text style={[styles.textdetail, {color: '#fff'}]}>
            ...
            focuses on highlighting the talent of Thai artisans, the creativity
            of young designers, and the exciting new collections from
            up-and-coming jewelers across Thailand. It also helps developing
            SMEs nationwide to promote Thai jewelry businesses to meet overseas
            buyers. The current edition showcases 179 exhibitors joining this
            project.
          </Text>
        </View>
        <View style={[styles.viewdetail, {backgroundColor: '#EEECE2'}]}>
          ...
          <Text style={[styles.textdetail, {color: '#636363'}]}>
            ...
            brands making a debut in the local and international market. The New
            Faces featured jewelry products from 160 SMEs from 31 provinces
            across Thailand, such as Chanthaburi, Tak, Sukhothai, Chiang Mai,
            Lampang, Pichit, Surin, Prachuab Khiri Khan, Nakhon Sri Thammarat,
            and Phang Nga, with an aim to provide the brands with an opportunity
            to expand to overseas markets, while increasing exposure and sales.
            With their glittering creativity and passion, newly-established
            brands from the New Faces offer a wide range of fresh well-designed
            products at the 64th Bangkok Gems & Jewelry Fair
          </Text>
        </View>
        <View style={styles.viewdetail}>
          <Image
          ...
          <Text style={[styles.textdetail, {color: '#fff'}]}>
            ...
            colored stones to enhance good luck, and jewelry made from stingray
            leather that will bring wealth and protect the wearer from harm.
          </Text>
        </View>
        <View style={[styles.viewdetail, {backgroundColor: '#EEECE2'}]}>
          <Image
          ...
          <Text style={[styles.textdetail, {color: '#636363'}]}>
            ...
            jewelry designs is endless. For the 62nd edition of the Bangkok Gems
            & Jewelry Fair, the DITP has carefully selected over 150 small
            jewelry brands with great potential from across Thailand for The New
            Faces showcase that is bigger and better than previous editions of
            the fair. From brands specializing in dainty designs to brands
            proudly showcasing bold statement jewelry, from classic, timeless
            designs to abstract and cutting-edge pieces for the fashionista,
            find them all at The New Faces showcase!
          </Text>
        </View>
        <View style={styles.viewdetail}>
          <Image
