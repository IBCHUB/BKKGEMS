        ...
        <ScrollView style={{backgroundColor: '#EEECE2'}}>
          <View style={styles.viewdetail}>
            ...
            <Text style={[styles.textdetail, {color: '#fff'}]}>
              An exhibition of contemporary silver jewelry from leading brands
              as well as a showcase of the history of silver jewelry in
              Thailand. The exhibition features the latest trends in silver
              jewelry that is catered to niche markets. The selected themes
              include Generation Silver, Modern Heritage, Fashion Charm,
              Lifestyle Silverware, and Urban Tribe.
            </Text>
          </View>
          <View style={[styles.viewdetail, {backgroundColor: '#EEECE2'}]}>
            ...
            <Text style={[styles.textdetail, {color: '#636363'}]}>
              A showcase of unique jewelry of emerging themes which are the
              target markets that have high growth potential in global markets,
              including 5 groups, namely:{'\n'}
          ...
          <View style={styles.viewdetail}>
            ...
            <Text style={[styles.textdetail, {color: '#fff'}]}>
              ...
              “Thailand’s Magic Hands: The Spirit of Jewelry-Making” at The
              Niche Showcase exhibition featuring 5 product groups with
              potential for trade in overseas markets: {'\n'}
              <Text style={[styles.textdetail, {color: '#DAA560'}]}>
                High Jewelry :
              </Text>{' '}
              Jewelry associated with royals (The highlight display is the
              replica of the Great Crown of Victory) made from the model of the
              crown that Rama IV or His Majesty King Mongkut granted to Napoleon
              III in 1861, representing the elaborated jewelry-making techniques
              of Thai artisans, made by Gallery Ver {'\n'}
              <Text style={[styles.textdetail, {color: '#DAA560'}]}>
                Heritage & Craftsmanship :
              </Text>{' '}
              Jewelry representing arts and culture inspired by Thai heritage
              such as flower garlands and crowns by PHOPHAN JEWELRY {'\n'}
              <Text style={[styles.textdetail, {color: '#DAA560'}]}>
                Spiritual Power :
              </Text>{' '}
              Jewelry of belief and opulence such as jewelry relating to Naga or
              mythological creatures from brands such as Bobby Gems & Jewelry
              and Jewel Pelle {'\n'}
              <Text style={[styles.textdetail, {color: '#DAA560'}]}>
                Luxe Men :
              </Text>{' '}
